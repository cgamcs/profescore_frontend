    ...
    return (
        <>
            ...
            >
                <div
                    className={`
                        modal-content bg-white dark:bg-[#202024] rounded-lg shadow-xl max-w-md w-full mx-4 overflow-hidden
                    ...
                    <div className="p-4">
                        ...
                        <form id="report-form" onSubmit={handleReport}>
                            ...
                            <div className="flex justify-end space-x-3">
                                <button
                                    type="button"
                                    className="px-4 py-2 border border-gray-300 dark:border-[#202024] bg-white dark:bg-[#383939] rounded-md shadow-sm text-sm font-medium text-gray-700 dark:text-gray-200 hover:cursor-pointer hover:bg-gray-50 dark:hover:bg-[#ffffff0d] transition-colors duration-200"
                                    onClick={closeReportModal}
                                >
                                    Cancelar
                                </button>
                                <button
                                    type="submit"
                                    className="px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 hover:cursor-pointer transition-colors duration-200"
                                >
                                    Enviar reporte
                                </button>
                            </div>
