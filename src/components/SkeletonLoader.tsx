        ...
        <section className="pb-12 bg-white dark:bg-[#0A0A0A]">
            <div className="container mx-auto px-4">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
                    {[...Array(8)].map((_, i) => (
                        <div key={i} className="bg-gray-200 dark:bg-[#181818] border border-gray-200 dark:border-[#383939] rounded-lg p-4 h-25 text-center animate-pulse"></div>
                    ))}
                </div>
            </div>
        </section>
        ...
        <section className="py-12 bg-gray-50 dark:bg-[#0A0A0A]">
            <div className="container mx-auto px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
                    {[...Array(3)].map((_, index) => (
                        <div key={index} className="bg-white dark:bg-[#181818] rounded-lg shadow-sm border border-gray-200 dark:border-[#383939] p-6 animate-pulse">
    ...
    return (
        <main className="container mx-auto px-4 py-6 dark:bg-[#0A0A0A]">
            ...
            <section className="mb-12">
                ...
                <div className="overflow-x-auto rounded-lg dark:bg-[#383939] border border-gray-200 dark:border-[#383939]  shadow-sm">
                    <div className="min-w-full divide-y divide-gray-200 dark:divide-[#383939]">
                        <div className="bg-gray-50 dark:bg-[#181818]">
                        ...
                        <div className="bg-white dark:bg-[#181818] divide-y divide-gray-200 dark:divide-[#383939]">
                            {[...Array(6)].map((_, i) => (
            ...
            <section>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {[...Array(3)].map((_, i) => (
                        <div key={i} className="bg-white dark:bg-[#181818] rounded-lg border border-gray-200 dark:border-[#383939] shadow-sm p-6 animate-pulse">
            ...
            <main className="container mx-auto px-4 py-6">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="md:col-span-1">
                        ...
                        <div className="bg-gray-200 dark:bg-[#383939] h-64 rounded-lg border border-gray-200 dark:border-[#383939] shadow-sm mb-6 animate-pulse"></div>
                        <div className="bg-gray-200 dark:bg-[#383939] h-40 rounded-lg border border-gray-200 dark:border-[#383939] shadow-sm animate-pulse"></div>
                        <div className="mt-6">
                    ...
                    <div className="md:col-span-2">
                        <div>
                            ...
                            <div className="space-y-4">
                                {[...Array(3)].map((_, i) => (
                                    <div key={i} className="bg-gray-200 dark:bg-[#383939] h-32 rounded-lg border border-gray-200 dark:border-[#383939] shadow-sm animate-pulse"></div>
                                ))}
                            </div>
                        </div>
                    </div>
